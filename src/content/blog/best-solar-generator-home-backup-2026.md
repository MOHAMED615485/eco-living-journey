...
I wrote a full breakdown on [how to calculate surge watts for your freezer here](/blog/what-is-lra-on-a-freezer/). Read that first if you're not sure what your freezer needs. It could save you from buying the wrong unit.
...
**What I didn't like:** The handle feels cheap for a unit this price. And the fan runs louder than I expected when output exceeds 1,000W.
...
The Bluetti is also expandable. You can add external battery packs to push capacity beyond 4,000Wh. That's genuinely useful if you live somewhere with frequent multi-day outages.

**What I didn't like:** The weight makes it hard to move alone. And at this price, you're making a real commitment.
...
| Fast charge | ✅ 0-80% in 1hr | ⚠️ Slow after 80% | ✅ Solid |
| App quality | Excellent | Good | Good |
| High-LRA handling | ✅ Reliable | ⚠️ Check LRA first | ✅ Reliable |
...
**Buy the Jackery Explorer 1000 V2 if:** Your freezer has an LRA under 9.0 and you want to save money without sacrificing too much performance.
