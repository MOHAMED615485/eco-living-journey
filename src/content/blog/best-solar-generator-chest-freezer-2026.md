...
If you are running a chest freezer only, the AC200L is overkill. The extra battery capacity sits unused and you paid for it. But if you want to run the freezer AND the refrigerator AND the lights, there is no better unit in this price range.
...
A 1000Wh capacity generator can run a chest freezer for 8-10 hours. But the watt-hour capacity is less important than the surge capacity. Make sure your generator's surge watts exceed your freezer's LRA x 120 or it will trip at startup.
