...
<div class="my-6 text-center md:text-left">
  <a href="https://amzn.to/4boW99s" target="_blank" rel="noopener noreferrer" class="inline-block bg-[#ea580c] text-white font-bold text-lg py-3 px-8 rounded shadow-md hover:bg-[#c2410c] transition-colors duration-200">
...
<div class="my-6 text-center md:text-left">
  <a href="https://amzn.to/4rA9JNl" target="_blank" rel="noopener noreferrer" class="inline-block bg-[#ea580c] text-white font-bold text-lg py-3 px-8 rounded shadow-md hover:bg-[#c2410c] transition-colors duration-200">
    🛒 Check Current Price on Amazon ➔
  </a>
</div>

<div class="my-6 text-center md:text-left">
  <a href="https://amzn.to/4sLYVMW" target="_blank" rel="noopener noreferrer" class="inline-block bg-[#ea580c] text-white font-bold text-lg py-3 px-8 rounded shadow-md hover:bg-[#c2410c] transition-colors duration-200">
    🛒 Check Current Price on Amazon ➔
  </a>
</div>
