...
article = """---
title: "What Appliances Can a Solar Generator Run? (Complete Wattage Guide)"
...
| Appliance | Running Watts | Surge Watts | 1000Wh Battery Runtime |
|:---|:---:|:---:|:---:|
| LED light bulb | 10W | 10W | 100 hours |
| Phone charger | 18W | 18W | 55 hours |
| Laptop | 45W | 45W | 22 hours |
| WiFi router | 10W | 10W | 100 hours |
| LED TV (55 inch) | 80W | 80W | 12 hours |
| Box fan | 50W | 75W | 20 hours |
| CPAP machine (no heat) | 30W | 30W | 33 hours |
| CPAP machine (with heat) | 60W | 60W | 16 hours |
| Mini fridge | 80W | 400W | 10 hours |
| Chest freezer (7 cu ft) | 150W | 800W | 6 hours |
| Full-size refrigerator | 150W | 1,200W | 6 hours |
| Microwave (700W) | 700W | 1,000W | 1.4 hours |
| Coffee maker | 900W | 900W | 1 hour |
| Electric blanket | 200W | 200W | 5 hours |
| Space heater (low) | 750W | 750W | 1.3 hours |
| Well pump (1/2 HP) | 500W | 2,000W | 2 hours |
| Window AC (5,000 BTU) | 500W | 1,500W | 2 hours |
| Sump pump | 800W | 1,300W | 1.2 hours |
| Electric stove burner | 1,500W | 1,500W | 0.6 hours |
| Central AC | 3,500W | 5,000W+ | Cannot run |
| Electric dryer | 5,000W | 5,000W | Cannot run |
| Electric water heater | 4,000W | 4,000W | Cannot run |
...
## What a 1,000Wh Generator Runs Easily
...
**Well pump** — A half-horsepower well pump surges to 2,000W on startup. You need a generator with at least 2,500W surge capacity. Read the [best solar generators for well pumps](/blog/best-solar-generator-well-pump/) guide for the exact models that work.
...
Use the [free solar calculator](/solar-calculator/) to run the numbers for your specific appliances before buying anything.
...
Yes — but only if the generator has enough surge capacity to handle the compressor startup. A full-size fridge surges to 1,200W on startup even though it only runs on 150W. You need a generator with at least 1,500W surge rating. The EcoFlow DELTA 3 Plus and Jackery Explorer 1000 V2 both handle this reliably.

**What size solar generator do I need for a chest freezer?**
A 7 cubic foot chest freezer runs on 150W but surges to around 800W on startup. Any generator with 1,000W+ surge capacity handles it. For a larger 15 cubic foot freezer surging to 1,200W, go with 1,500W surge minimum. Read the full [chest freezer blackout math guide](/blog/chest-freezer-blackout-math/) for the complete calculation.

**Can I run a microwave on a solar generator?**
Yes, briefly. A 700W microwave needs 1,000W+ output and drains a 1,000Wh battery in about 1.4 hours of continuous use. Use it to reheat food quickly rather than cooking full meals during an outage.

**Can a solar generator run a CPAP machine?**
Yes — this is one of the best use cases for a solar generator. A CPAP without heated humidifier draws only 30W. A 1,000Wh battery runs it for 33 hours — more than two full nights. With a heated humidifier add roughly 30W more.

**What appliances should I never run on a solar generator?**
Central air conditioning, electric water heaters, electric dryers, and electric stoves all draw 3,500–6,000W — far beyond what any portable solar generator can handle. Stick to essentials: lights, refrigeration, communication devices, fans, and medical equipment.

**How do I calculate how long my battery will last?**
Divide your battery capacity in watt-hours by the appliance wattage. Example: 1,000Wh ÷ 150W fridge = 6.6 hours. Use the [free solar calculator](/solar-calculator/) to run this for multiple appliances at once.
...
If you want to know which specific generator is right for your situation, start with the [best solar generators for home backup guide](/blog/best-solar-generator-home-backup-2026/) — or jump straight to the [best solar generators under $1,000](/blog/best-solar-generator-under-1000/) if budget is your main concern.
...
output_path = "src/content/blog/what-appliances-can-solar-generator-run.md"
...
print("SUCCESS — Article created at:", output_path)
print("Word count approximately:", len(article.split()))
